      ...
      >
            ...
            <div className="flex flex-wrap justify-center gap-2 max-w-md">
               {SUGGESTED_QUESTIONS.map((q, i) => (
                 <button 
                  ...
                  className="px-4 py-2 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl text-[11px] font-bold text-slate-600 dark:text-slate-300 hover:border-blue-500 hover:text-blue-600 transition-all shadow-sm"
                 >
                   {q}
                 </button>
               ))}
        ...
        {isLoading && (
          <div className="flex items-start gap-4 animate-in fade-in duration-300">
            ...
            <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl rounded-tl-none p-5 flex items-center gap-3">
