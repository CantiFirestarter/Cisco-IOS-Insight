...
import { ShieldCheck, Lock, Zap, ExternalLink, Key, Check, Info, AlertCircle } from 'lucide-react';
          ...
          <div className="space-y-4">
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <Key className={`w-4 h-4 transition-colors ${validationStatus === 'error' ? 'text-red-500' : validationStatus === 'success' ? 'text-emerald-500' : 'text-slate-500'}`} />
              </div>
              <input
                type="password"
                value={apiKeyInput}
